...
5-fold cross-validation RMSE and $R^2$ results were also calculated. Here the support vector regressor and the random forest regressor both achieved the best $R^2$ scores of 0.622. In the end, the decision to select the support vector regressor was solely based on the faster compute time for this algorithm.
